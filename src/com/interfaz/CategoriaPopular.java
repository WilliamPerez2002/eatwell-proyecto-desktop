 ...
 * @author marlo
 */
public class CategoriaPopular extends javax.swing.JDialog {

    /**
     * Creates new form CategoriaPopular
     */
    public CategoriaPopular(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void reporteCategorias() {
        ...
        ArrayList<String[]> datos = rf.categoriasPopulares();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategoriaPopular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CategoriaPopular dialog = new CategoriaPopular(new javax.swing.JFrame(), true);
